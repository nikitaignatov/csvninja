<div class="lg:2/6 xl:w-2/4 mt-20 lg:mt-30 lg:ml-10 text-left">
    ...
    <h2 class="mt-6 text-xl font-light text-true-gray-500 antialiased">
        Visual tool for manual annotation and labelling of signal data. Allows
        you to progress faster with supervised learning AI algorithms.
    </h2>
    <button
        on:click
